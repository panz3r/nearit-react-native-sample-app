...
```bash
# Clone repo
git clone https://github.com/panz3r/nearit-react-native-sample-app.git
# cd into cloned folder
cd ./nearit-react-native-sample-app
...
Generate a `secrets.xml` file under `android/app/src/main/res/values`
...
Generate a `NearIt.plist` file under `ios/nearsdksample`
